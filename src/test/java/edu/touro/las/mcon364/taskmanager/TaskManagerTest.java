...
class TaskManagerTest {
    ...
    void testRunUpdateTaskCommand() {
        ...
        assertEquals(Priority.HIGH, registry.get("Update me").orElseThrow(() -> new TaskNotFoundException("Update me")).priority(),
    ...
    void testRunMultipleCommands() {
        ...
        assertEquals(Priority.MEDIUM, registry.get("Task 2").orElseThrow(() -> new TaskNotFoundException("Task 2")).priority(),
